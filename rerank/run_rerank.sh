...
PYTHONPATH=$PWD python rerank/rerank.py \
    ...
    --rank_results_path data/fiqa/bge_en_icl_all_1000_sampled_400.tsv \
    --qrels_path data/fiqa/qrels/test_sampled_400.tsv \
    --queries_path data/fiqa/queries_sampled_400.jsonl \
    --corpus_path data/fiqa/corpus.jsonl \
    --output_path data/fiqa/deberta_margin_mse_reranked_top100_sampled_400.tsv \
    --hits_per_query 100 \
    --flush_interval 32 \
    --qid_base 16
