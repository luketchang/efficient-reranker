...
def main(rank_results_path, positives_path, top_k_perc=0.95, remove_positives=False):
...
if __name__ == "__main__":
    ...
    main(args.rank_results_path, args.positives_path, top_k_perc=args.top_k_perc, remove_positives=args.remove_positives)