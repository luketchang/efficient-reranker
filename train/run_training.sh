...
accelerate launch train/train_script.py \
    ...
    --queries_paths data/nq-train/queries_sampled_6250.jsonl \
    --corpus_paths data/nq/corpus.jsonl data/hotpotqa/corpus.jsonl data/fiqa/corpus.jsonl \
    --train_positive_rank_results_paths data/nq-train/nv_rerank_positives_sampled_6250.tsv \
    --train_negative_rank_results_paths data/nq-train/nv_rerank_negatives_top100_sampled_6250_filtered.tsv \
    --train_qid_bases 10 \
